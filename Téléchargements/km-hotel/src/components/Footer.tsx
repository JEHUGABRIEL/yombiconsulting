    ...
    <footer className="bg-slate-950 text-slate-300 py-12 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm font-light">
              ...
              <li>
                <Link to="/chambres" className="hover:text-brand-400 transition-colors">
                  {t('nav.rooms')} & Suites
                </Link>
              </li>
              <li>
                <Link to="/#services" className="hover:text-brand-400 transition-colors">
                  {t('nav.services')} & Équipements
                </Link>
              </li>
              <li>
                <Link to="/restaurant-bar" className="hover:text-brand-400 transition-colors">
                  {t('nav.restaurantBar')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            {/* Social Icons */}
            <div className="mt-6">
              <h6 className="text-white/50 font-medium uppercase tracking-wider text-xs mb-3">
                {t('footer.followUs')}
              </h6>
              <div className="flex items-center gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-800 text-slate-400 hover:bg-brand-600 hover:text-white transition-all duration-300 hover:scale-110"
                  >
                    {social.icon}
                  </a>
                ))}
        ...
        <div className="pt-8 border-t border-slate-800 text-sm font-light text-slate-500 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="mt-2 md:mt-0">{t('footer.founded')}</p>
        </div>
      </div>
    </footer>
  );
